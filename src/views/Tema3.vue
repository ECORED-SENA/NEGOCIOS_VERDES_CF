  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .titulo-principal(data-aos="flip-up")
      .titulo-principal__numero
        span 3
      h1 Procesos de logística
    
    .row.bgImg01.mb-5.justify-content-center.align-items-center
    ...
    .video
      iframe(width="560" height="315" src="https://www.youtube.com/embed/cpcaIPy5-oc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
